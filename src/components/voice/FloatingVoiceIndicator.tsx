...
export const FloatingVoiceIndicator: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 rounded-full border border-primary/30 bg-background/95 backdrop-blur-sm shadow-lg px-4 py-2 animate-in slide-in-from-bottom-4">
