...
export const NdaText: React.FC = () => {
  return (
    <div className="prose prose-sm max-w-none text-sm text-gray-700 dark:text-gray-300">
      ...
      <h3 className="text-lg font-medium" id="section-1">1. CONFIDENTIALITY AGREEMENT</h3>
      ...
      <h3 className="text-lg font-medium" id="section-2">2. CONFIDENTIAL INFORMATION</h3>
      ...
      <ul className="list-disc pl-5 space-y-1" aria-label="Confidential information items">
      ...
      <h3 className="text-lg font-medium" id="section-3">3. RECIPIENT'S OBLIGATIONS</h3>
      
      <p>Recipient agrees to:</p>
      
      <ul className="list-disc pl-5 space-y-1" aria-label="Recipient obligations">
      ...
      <h3 className="text-lg font-medium" id="section-4">4. TERM</h3>
      ...
      <h3 className="text-lg font-medium" id="section-5">5. DIGITAL SIGNATURE</h3>
