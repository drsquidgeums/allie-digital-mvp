...
// Define our highlight type that aligns with the library's IHighlight
...
type HighlightType = {
  ...
  position: {
    boundingRect: Scaled & { pageNumber: number };
    rects: Array<Scaled & { pageNumber: number }>;
    pageNumber: number;
  };
  comment?: { text: string }; // Match the library's Comment type
};
